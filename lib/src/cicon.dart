...
class CIcon extends StatelessWidget {
  ...
  /// 24.0.
  ///
  /// If this [CIcon] is being placed inside an [IconButton], then use
  ...
  /// [IconTheme] to pass down the size to the [CIcon].
  final double size;
  ...
  /// set to true, and the [CIcon] widget uses the [textDirection] to determine
  ...
  Widget build(BuildContext context) {
    ...
    Color iconColor = color ?? icon.iconIcon ?? iconTheme.color;
